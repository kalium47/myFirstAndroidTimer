    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonSet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(input.length() == 0){
                    Toast.makeText(MainActivity.this, "Nah Cant be Empty :D", Toast.LENGTH_SHORT).show();
                    return;
                }

                long millisInput = Long.parseLong(input) * 60000;
                if(millisInput == 0){
                    Toast.makeText(MainActivity.this, "Positive Number la :D", Toast.LENGTH_SHORT).show();
                    return;
                }
